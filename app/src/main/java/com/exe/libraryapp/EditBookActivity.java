...
public class EditBookActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EDIT_BOOK_TITLE = "com.exe.libraryapp.EDIT_BOOK_TITLE";
    public static final String EXTRA_EDIT_BOOK_AUTHOR = "com.exe.libraryapp.EDIT_BOOK_AUTHOR";
